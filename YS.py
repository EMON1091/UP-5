...
def random_dalvik_ua_working_2():
    android_versions = ["11", "12", "13", "14"]   # Updated Android versions
    
    devices = [
        # Brand, Model, Build, Resolution (width, height), Density
        ("Xiaomi", "Redmi Note 11", "SP1A.210812.016", "1080", "2400", "2.0"),
        ("Xiaomi", "Redmi Note 10 Pro", "QKQ1.200830.002", "1080", "2400", "2.0"),
        ("Samsung", "Galaxy A32", "RP1A.200720.011", "1080", "2400", "2.0"),
        ("Samsung", "Galaxy A52", "SP1A.210812.016", "1080", "2400", "2.25"),
        ("Realme", "Realme 8i", "RP1A.200720.012", "1080", "2412", "2.1"),
        ("Oppo", "A74", "QP1A.190711.020", "1080", "2400", "2.0"),
        ("Vivo", "Y21", "RP1A.200720.011", "720", "1600", "1.5"),
        ("Infinix", "Note 12", "SP1A.210812.016", "1080", "2400", "2.0"),
        ("Google", "Pixel 6", "SD1A.210817.015", "1080", "2400", "2.5"),
    ]
    
    brand, model, build, width, height, density = random.choice(devices)
    android_version = random.choice(android_versions)
    
    ua = (f"Dalvik/2.1.0 (Linux; U; Android {android_version}; "
          f"{model} Build/{build}) "
          f"[FBAN/FB4A;FBAV/{random.randint(350, 420)}.0.0."
          f"{random.randint(10, 150)}.{random.randint(50, 200)};"
          f"FBDM/{{density={density},width={width},height={height}}};"
          f"FBLC/en_US;FBMF/{brand};FBBD/{brand};FBPN/com.facebook.katana]")
...
\033[92;1m[\033[91;1m●\033[92;1m] TOOLS       \033[91;1m●\033[92;1m FILE M-2
\033[92;1m[\033[91;1m●\033[92;1m] VERSION     \033[91;1m●\033[92;1m 4.5
\33[1;37m==============================================""")
def linex():
        print(f"\33[1;37m==============================================""")
def clear():
...
"fb_api_caller_class": "com.facebook.account.login.protocol.Fb4aAuthHandler",
"api_key": "882a8490361da98702bf97a021ddc14d"}
                headers = {'User-Agent': random_dalvik_ua_working_2(),
'Content-Type': 'application/x-www-form-urlencoded',
'Host': 'graph.facebook.com',
